...
<script type="text/javascript">
    ...
    var tA = "javascript:load_content('customer/edit/";
    ...
    var oTable = $('#customertable').dataTable( {
            ...
            "bServerSide": true,
            "sScrollY": "360px",
            "sAjaxSource": '<?php echo base_url(); ?>customer/datatable',
                "bJQueryUI": true,
...
<script type="text/javascript">
    ...
    function delconfirm(recid) {
        ...
        if(conf) {
            load_content('customer/delete/'+recid, '#tab_loader');
        }
    }
</script>
...
<div id="form_loader">
    <div class="form_block2" id="person_form" style="width:1000px; margin-left:23px; margin-top:2px;">
        <div class="form_title">List of Customers</div>

        <table cellpadding="0" cellspacing="0" border="0" id="customertable" width="100%">
            <thead>
                <tr>
                    <th width='0%'>ID</th>
                    <th width='31%'>Name</th>
