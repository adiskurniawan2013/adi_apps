...
<head>
	...
	<!-- Bootstrap -->
	<link href="<?php echo site_url('js/bootstrap/css/bootstrap.min.css'); ?>" rel="stylesheet">
	...
	<script src="<?php echo site_url('js/bootstrap/js/bootstrap.min.js'); ?>"></script>
	<script src="<?php echo site_url('js/bootstrap/js/bootstrap-datepicker.js'); ?>"></script>
